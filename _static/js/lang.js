$(document).ready(function() {
	...
	pageURL = pageURL.replace("https://docs.6zip.online/" + DOCUMENTATION_OPTIONS['LANGUAGE'] , "");
	$.each(langs, function(index, value) {
		var link = document.createElement('link');
		link.rel = "alternate";
		link.hreflang = value;
		if (value == "x-default") {
			link.href = "https://docs.6zip.online/en" + pageURL;
		} else if (value == "zh-Hans") {
			link.href = "https://docs.6zip.online/zh_CN" + pageURL;
		} else if (value == "zh-Hant") {
			link.href = "https://docs.6zip.online/zh_TW" + pageURL;
		} else {
			link.href = "https://docs.6zip.online/" + value + pageURL;
		}
...
$(function(){
	var siteURL = "https://docs.6zip.online/";
