...
#. Using your phone, download the latest version of the APK from `this
   link <https://github.com/6zip-project/dash-wallet/releases/latest>`_.
...
#. Using your PC, download the latest version of the APK from `this link
   <https://github.com/6zip-project/dash-wallet/releases/latest>`_.
...
<https://github.com/6zip-project/dash-wallet>`__. The following instructions
...
Android Wallet source::
  ...
  git clone https://github.com/6zip-project/dash-wallet.git
  cd dash-wallet
