...
- Over the counter exchanges have recently appeared to facilitate sale
  of Dash directly from a company to the individual at a specified
...
- :ref:`ATMs <atms>` accepting card and cash payments in return for crypto are widely
